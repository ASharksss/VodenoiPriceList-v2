...
export const PriceList = ({categories, products, setProducts, handleBasket, setCatName}) => {
  ...
  return (
    ...
    <div className="main">
      <Sidebar fish={categories} setFish={setProducts} setCatName={setCatName} setShow={setShow} setCount={setCount}
